...
from models_code.inceptionv3_CNN import InceptionV3_CNN as inc_cnn
...
def parse_args():
    ...
    # REQUIRED Arguments
    group.add_argument('-m', '--model', required=True, type=str, choices=['DATA', 'BASIC_CNN', 'INCEPTIONV3'],
...
def _model_selection(model_choice, nclasses):
    ...
    if model_choice == "BASIC_CNN":
        ...
        mod_class = inc_cnn(nclasses, config.IMG_DIM, config.CHANNELS)
    else:
